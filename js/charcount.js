...
function parseCharCounts()
{
	...
	for(var i=0; i < elements.length; i++)
	{
		...
		if(element.getAttribute('maxlength') != null && element.getAttribute('limiterid') == null)
		{
			...
			newlabel.style.color = 'red'; //this doesn't seem to work in new browsers
...
function displayCharCounts(element)
{
	...
	if(remaining >= 0)
	{
		limitLabel.style.color = '#800000'; //replaced green with maroon, replaced 
	...
	else
	{
		if (enforceLength == true) {
			...
			limitLabel.style.color = '#800000'; //replaced green with maroon
			...
			limitLabel.style.color = 'red'; //this doesn't seem to work in new browsers
